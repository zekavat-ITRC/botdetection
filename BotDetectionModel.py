...
tf,specific, hashtag, embed=preprocessingandSpecial(bot,human,'data\\AllTweetsPerUser.xlsx')
X=specific
...
classifierModel(result_X_train, result_X_test, y_result_train, y_result_test,classifier,'model\\allfeature_classification_model.pkl')
stop=timeit.default_timer()
